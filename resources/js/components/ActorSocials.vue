<template>
    <ul class="flex items center mt-4">
        <li v-show="actor.facebook">
            <a :href="actor.facebook" target="_blank" title="Facebook">
                <svg
        ...
        <li class="ml-6" v-show="actor.instagram">
            <a :href="actor.instagram" target="_blank" title="Instagram">
                <svg
                    class="fill-current text-gray-400 hover:text-white w-6"
                    viewBox="0 0 448 512"
                >
        ...
        <li class="ml-6" v-show="actor.twitter">
            <a :href="actor.twitter" target="_blank" title="Twitter">
                <svg
                    class="fill-current text-gray-400 hover:text-white w-6"
                    viewBox="0 0 512 512"
                >
        ...
        <li class="ml-6" v-show="actor.homepage">
