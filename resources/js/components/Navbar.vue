<template>
    <nav class="border-b border-gray-800">
        <div
            class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6"
        >
            <ul class="flex flex-col md:flex-row items-center">
                ...
                <li class="md:ml-6 mt-3 md:mt-0">
                    <router-link to="/tv" class="hover:text-gray-300"
                        >TV Shows</router-link
                    >
                </li>
                <li class="md:ml-6 mt-3 md:mt-0">
                    <router-link to="/actors/page/1" class="hover:text-gray-300"
                        >Actors</router-link
                    >
                </li>
            </ul>
