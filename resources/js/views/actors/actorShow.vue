<template>
    <div class="container mx-auto" v-if="actor">
        ...
        <div class="credits border-b border-gray-800">
            <div class="container mx-auto px-4 py-16">
                ...
                <ul
                    ...
                    v-for="show in actor.credits"
                >
                    <li>
                        {{ show.release_year }} &middot;
                        <strong
                            ><router-link
                                :to="{
                                    path: '/' + show.media_type + '/' + show.id
                                }"
...
import ActorSocials from "../../components/ActorSocials";
import ActorKnownFor from "../../components/ActorKnownFor";
...
export default {
    ...
    mounted() {
        axiosWithApiUrl
            .get("/actors/" + this.$route.params.id)
            .then(response => {
