            ...
            <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
                ...
                <div class="md:ml-24">
                    ...
                    >
                        ...
                        <span class="mx-2">|</span>
                        <span v-for="(genre, index) in show.genres">
                            {{ genre.name
                            }}<span v-if="index != show.genres.length - 1"
                                >,&nbsp;
                            </span>
                        </span>
                    </div>
                    ...
                    <div class="mt-12">
                        <div class="flex mt-4">
                            <div class="mr-8" v-for="crew in show.created_by">
                                <div>{{ crew.name }}</div>
                    ...
                    <TrailerModal :trailerLink="show.youtube_link" />
                </div>
            </div>
        </div>
...
export default {
    ...
    mounted() {
        axiosWithApiUrl.get("/tv/" + this.$route.params.id).then(response => {
